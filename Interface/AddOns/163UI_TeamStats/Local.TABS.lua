...
TS.VERSION_BOSSES = { -13322, "珍娜", -12536, "戈霍", } --12110, "阿" -11874, "基" -- -11195, "古", --引领潮流 -11194, "萨", -11581, "海", 引领潮流：Ahead of the Curve: 千钧一发 Cutting Edge:


local RES = {
  {
      tab = "总览",
      ids = { 7399, -13079, -13080, -13448, -13449},
      widths = { 70, 50, 50, 50, 50 },
      names = { "大秘次数", "S1钥石", "S1大师", "S2钥石", "S2大师"},
...
table.insert(TABS, {
    ...
    names = { "珍娜", "戈霍", "阿古", "基丹", "古尔", "海拉", "萨维", "阿克", "黑手", "悬槌", "小吼", "莱登", "雷神", "永春", "恐心", "魔古" },
})
