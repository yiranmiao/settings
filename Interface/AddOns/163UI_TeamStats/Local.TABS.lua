...
TS.DATA_VERSION = 20181230

TS.VERSION_BOSSES = { -12536, "戈霍恩", } --12110, "阿" -11874, "基" -- -11195, "古", --引领潮流 -11194, "萨", -11581, "海", 引领潮流：Ahead of the Curve: 千钧一发 Cutting Edge:

local RES = {
  {
      tab = "总览",
      ids = { 7399, -13079, -13080},
      widths = { 70, 46, 46 },
      names = { "大秘次数", "10限", "15限"},
      tips = { "史诗秘钥副本总次数（所有版本挑战副本次数总和）", "《争霸艾泽拉斯》钥石征服者：第一赛季（全10层限时）", "《争霸艾泽拉斯》钥石大师：第一赛季（全15层限时）"}
  },
}
...
local INSTANCES = {
    ...
    {
        bosses = {
            { "塔罗克", 12787, 12788, {12789, -12524} },
            { "纯净圣母", 12791, 12792, {12793, -12526} },
            { "泽克沃兹，恩佐斯的传令官", 12799, 12800, {12801, -12527} },
            { "维克提斯", 12803, 12804, {12805, -12529} },
            { "腐臭吞噬者", 12795, 12796, {12797, -12530} },
            { "重生者祖尔", 12809, 12810, {12811, -12531} },
            { "拆解者米斯拉克斯", 12814, 12815, {12816, -12532} },
            { "戈霍恩 ", 12818, 12819, {12820, -12533} },
        },
        diff = { "", "H奥迪", "M奥迪", },
        tab = "奥迪尔",
    },
...
table.insert(TABS, {
    ...
    any_done = true,
    ids = {
        {-12535}, {-12111}, {-11875}, {-11192}, {-11580}, {-11191},
        {-10045}, {-9443}, {-9442},
        {-8401, -8400}, {-8260}, {-8238}, {-7487}, {-7486}, {-7485},
    },
    widths = { 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, },
    tips = {
        "千钧一发：戈霍恩", "千钧一发：阿古斯", "千钧一发：基尔加丹", "千钧一发：古尔丹", "千钧一发：海拉", "千钧一发：萨维斯",
        "千钧一发：黑暗之门（阿克蒙德）", "千钧一发：黑手的熔炉", "千钧一发：元首之陨",
        "千钧一发：加尔鲁什·地狱咆哮（10人或25人）", "千钧一发：莱登", "千钧一发：雷神",
        "千钧一发：惧之煞", "千钧一发：大女皇夏柯希尔", "千钧一发：皇帝的意志",
    },
    names = { "戈霍", "阿古", "基丹", "古尔", "海拉", "萨维", "阿克", "黑手", "悬槌", "小吼", "莱登", "雷神", "永春", "恐心", "魔古" },
})
