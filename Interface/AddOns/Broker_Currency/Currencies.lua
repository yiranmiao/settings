...
local CURRENCY_IDS_BY_NAME = {
    ...
    HORDE_81 = 1716, -- Honorbound Service Medal
    ALLIANCE_81 = 1717, -- 7th Legion Service Medal
    TITAN_RESIDUUM = 1718, -- Titan Residuum
}
...
local PVP_CURRENCY_IDS = {
    ...
    CURRENCY_IDS_BY_NAME.HORDE_81,
    CURRENCY_IDS_BY_NAME.ALLIANCE_81,
}
